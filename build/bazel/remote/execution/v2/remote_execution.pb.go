...
type Command struct {
	...
	// have the same result.
	// A detailed lexicon for this can be found in the accompanying platform.md.
	// DEPRECATED as of v2.2: platform properties are now specified directly in the
	// action to allow execution services to make routing decisions based on these
	// without introducing an additional step to reach the CAS to determine the
	// properties.
